...
public class AssistantDatabase {
    ...
    private static final String DATABASE_NAME = "assistantDatabase";
    ...
    //constructor
    public AssistantDatabase(Context c) {
        passedContext = c;
    }

    //method to open database
    public AssistantDatabase open() throws SQLException {
